    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Reportes - Lista de Ventas de Productos</h1>
                    </div>
                </div>
            </div>
        </section>
...
export default {
    data() {
        return {
            ...
            listFiltro: ["Todos", "Categoría", "Producto", "Rango de fechas"],
            errors: [],
            sucursal_id: [],
            listSucursales: [],
            listCategorias: [],
    ...
    methods: {
        ...
        generaReporte() {
            ...
            axios
                .post("/admin/reportes/venta_productos", this.oReporte, config)
                .then((res) => {
                    this.errors = [];
                    this.enviando = false;
