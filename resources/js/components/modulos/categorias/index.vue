    ...
    computed: {
        ...
        textoTitulo() {
            if (this.accion == "nuevo") {
                ...
                let aux = this.oCategoria.nombre;
                return (
    ...
    methods: {
        ...
        enviarRegistro() {
            ...
            try {
                ...
                formdata.append(
                    "nombre",
                    this.oCategoria.nombre ? this.oCategoria.nombre : ""
                );
                if (this.accion == "edit") {
                    url = "/admin/categorias/" + this.oCategoria.id;
