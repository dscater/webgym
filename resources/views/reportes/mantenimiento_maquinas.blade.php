...
<head>
    <meta charset="UTF-8">
    <title>MantenimientoMaquinas</title>
    <style type="text/css">
        * {
...
<body>
    ...
    <div class="encabezado">
        ...
        <h4 class="texto">LISTA DE MANTENIMIENTO DE MÁQUINAS</h4>
    ...
    <table border="1">
        ...
        <tbody>
            @php
                $cont = 1;
            @endphp
            @foreach ($mantenimiento_maquinas as $mantenimiento_maquina)
                <tr>
                    ...
                    <td>{{ $mantenimiento_maquina->fecha_registro }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
