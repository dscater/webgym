...
<body>
    ...
    <table class="datos_factura">
        <tbody>
            <tr>
                ...
                <td>{{ $cobro->cliente->paterno }}</td>
                <td class="c2"><strong>Fecha: </strong> </td>
                <td>{{ date('d-m-Y', strtotime($cobro->fecha_cobro)) }}</td>
            </tr>
            <tr>
                <td class="c2"><strong>NIT/C.I.: </strong></td>
                <td>{{ $cobro->cliente->ci }}</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
        </tbody>
    ...
    <table class="factura">
        ...
        <tbody>
            @php
                $total = $cobro->inscripcion->plan->costo;
            @endphp
            <tr>
                <td>1</td>
    ...
    <div class="qr">
        <img src="{{ asset('imgs/qr/' . $cobro->qr) }}" alt="">
    </div>
</body>
